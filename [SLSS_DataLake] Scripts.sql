USE [Test_SLSS_DataLake]
GO
/****** Object:  Table [dbo].[tbl_Calendar]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_CustomerList]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON


--DROP TABLE [dbo].[tbl_CustomerList]
...
CREATE TABLE [dbo].[tbl_CustomerList](
    ...
    [Customer ID] [nvarchar](13),
    [Customer Name] [nvarchar](255),
    [Legal Name of Business] [nvarchar](255),
    [Trade Name] [nvarchar](255),
    [Group] [nvarchar](255),
    [Contact Person] [nvarchar](255),
    [Address-1] [nvarchar](255),
    [Address-2] [nvarchar](255),
    [Address-3] [nvarchar](255),
    [Pin Code] [nvarchar](6),
    [Town/City] [nvarchar](255),
    [Taluka] [nvarchar](255),
    [District] [nvarchar](255),
    [State] [nvarchar](255),
    [Country] [nvarchar](255),
    [Phone] [nvarchar](20),
    [Mobile No] [nvarchar](10),
    [WhatsApp No] [nvarchar](12),
    [Email] [nvarchar](255),
    [GST No] [nvarchar](20),
    [Taxpayer Type] [nvarchar](50),
    [GSTIN / UIN Status] [nvarchar](50),
    [Constitution of Business] [nvarchar](50),
    [PAN No] [nvarchar](20),
    [PAN Status] [nvarchar](255),
    [Aadhar No] [nvarchar](20),
    [Whether Aadhaar Authenticated] [nvarchar](10),
    [MSME No] [nvarchar](20),
    [Ledger Status] [nvarchar](255),
    [Customer Category] [nvarchar](50),
    [Sales Person] [nvarchar](255),
    [Customer Type] [nvarchar](50),
    [Potential] DECIMAL(18, 2),
    [Target] DECIMAL(18, 2),
    [Turn Over] DECIMAL(18, 2),
    [Credit days] INT,
    [Credit Limit] DECIMAL(18, 2),
    [Date of Creation] DATE,
    [Core Branch] [nvarchar](255),
    [Contact Mode] [nvarchar](50),
...
--CREATE TABLE [dbo].[tbl_CustomerList](
	...
	[Mobile No] [nvarchar](10) NULL,
	[WhatsApp No] [nvarchar](12) NULL,
...
/****** Object:  Table [dbo].[tbl_ItemsList]    Script Date: 8/26/2023 1:21:02 PM ******/
...
/****** Object:  Table [dbo].[tbl_OutStandings]    Script Date: 8/26/2023 1:21:02 PM ******/
...
CREATE TABLE [dbo].[tbl_OutStandings] (
    ...
    [Sales Man] VARCHAR(255),
    [PAN No] VARCHAR(20),
    [Customer ID] VARCHAR(50),
    [Group] VARCHAR(255),
    [GST No] VARCHAR(20),
    [Customer Name] VARCHAR(255),
    [Opening Amount] DECIMAL(18, 2),
    [Pending Amount] DECIMAL(18, 2),
    [Due on] DATE,
    [Overdue (by days)] INT,
    [Created Date] [datetime] NOT NULL,
...
/****** Object:  Table [dbo].[tbl_OutStandingsHistory]    Script Date: 8/26/2023 1:21:02 PM ******/
/*SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[tbl_PotentialCustomers]    Script Date: 8/26/2023 1:21:02 PM ******/
...
/****** Object:  Table [dbo].[tbl_PurchaseSummary]    Script Date: 8/26/2023 1:21:02 PM ******/
...
/****** Object:  Table [dbo].[tbl_ReceiptRegister]    Script Date: 8/26/2023 1:21:02 PM ******/
...
/****** Object:  Table [dbo].[tbl_SalesTeam]    Script Date: 8/26/2023 1:21:02 PM ******/
...
/****** Object:  Table [dbo].[tbl_SalesVouchers]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[tbl_StockDetails_CB]    Script Date: 8/26/2023 1:21:02 PM ******/
...
/****** Object:  Table [dbo].[tbl_TargetCustomers]    Script Date: 8/26/2023 1:21:02 PM ******/
...
/****** Object:  Table [dbo].[tbl_TargetCustomersHistory]    Script Date: 8/26/2023 1:21:02 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[USP_SLSS_CustomerList_Load]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Truncate the existing table if needed (commented out for now).
        -- TRUNCATE TABLE [dbo].[tbl_CustomerList];

        -- Load data into the temporary table #CustomerList from the Excel file.
        SELECT DISTINCT
            [Branch Name],[Customer ID],[Customer Name],[Legal Name of Business],
            [Trade Name],[Group],[Contact Person],[Address-1],[Address-2],[Address-3],[Pin Code],
            [Town/City],[Taluka],[District],[State],[Country],[Phone],[Mobile No],[WhatsApp No],[Email],
            [GST No],[Taxpayer Type],[GSTIN / UIN Status],[Constitution of Business],[PAN No],[PAN Status],
            [Aadhar No],[Whether Aadhaar Authenticated],[MSME No],[Ledger Status],[Customer Category],
            [Sales Person],[Customer Type],[Potential],[Target],[Turn Over],[Credit days],
            [Credit Limit],[Date of Creation],[Core Branch],[Contact Mode]
        INTO #CustomerList
        FROM OPENROWSET(
            'Microsoft.ACE.OLEDB.12.0',
            'Excel 12.0;Database=E:\Source_Files\Customer List.xlsx;HDR=YES;IMEX=1',
        ...
        SET @Transaction_Message = 'Data loaded successfully.';
    END TRY
    BEGIN CATCH
        ...
        -- Set transaction status to failure and capture error message.
        SET @Transaction_Status = -1;
        SET @Transaction_Message = ERROR_MESSAGE();
    END CATCH;
END;
...
SELECT DIstinct  [Branch Name],[Customer ID],[Customer Name],[Legal Name of Business],[Trade Name],
[Group],[Contact Person],[Address-1],[Address-2],[Address-3],
[Country],[State],[Pin Code],[Phone],[Mobile No],[Email],[GST No],[Aadhar No],
[PAN No],[Credit days],[Credit Limit in INR],[Location],[Sales Person],
[Customer Category],[Customer Type],[WhatsApp No],[District],[Taluka],[Potential],
[Target],[DOB],[Anniversary],[Date of Creation],[Status],[Turn Over],[MSME No]
Into #CustomerList
...
END  
GO
/****** Object:  StoredProcedure [dbo].[USP_SLSS_ItemsList_Load]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[USP_SLSS_OutStandings_Load]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[USP_SLSS_OutStandingsHistory_Load]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[USP_SLSS_PotentialCustomers_Load]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[USP_SLSS_PurchaseSummary_Load]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[USP_SLSS_ReceiptRegister_Load]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[USP_SLSS_SalesTeam_Load]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[USP_SLSS_SalesVouchers_Load]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[USP_SLSS_StockDetails_CB_Load]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[USP_SLSS_TargetCustomers_Load]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[USP_SLSS_TargetCustomersHistory_Load]    Script Date: 8/26/2023 1:21:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
